...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`smk_v1` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Data for the table `tb_aktiviti_log` */
...
/*Data for the table `tb_cawangan` */
...
/*Data for the table `tb_kategori_skim` */
...
/*Data for the table `tb_keturunan` */
...
/*Data for the table `tb_kumpulan` */
...
/*Data for the table `tb_lampiran` */
...
/*Data for the table `tb_panggilan` */
...
insert  into `tb_pengguna`(`id_pengguna`,`nokp`,`nama`,`id_penjawatan_skim`,`status_aktif`,`jenis_pengguna`,`konsol_pentadbir`,`id_tempat_bertugas`,`id_penjawatan_skim_rekod`,`id_panggilan`,`id_gelaran`,`id_agama`,`id_keturunan`,`id_ketua`,`id_negeri_kelahiran`,`katalaluan`,`t_lahir`,`jantina`,`id_takaktif`,`taraf_perkahwinan`,`oku`,`tel_pejabat`,`tel_faks`,`tel_bimbit`,`tel_rumah`,`namawaris`,`pekerjaanwaris`,`jawatanwaris`,`hubunganwaris`,`tarikhlahirwaris`,`alamatwaris`,`alamatbertugaswaris`,`tel_pejabatwaris`,`tel_rumahwaris`,`tel_bimbitwaris`,`kementerian`,`jabatan`,`pekerjaan`,`tarafperkhidmatan`,`tangga_gaji`,`alamat_emel`,`alamat_pejabat`,`fail_peribadi`,`alamat_rumah`,`lokaliti`,`t_akhirkemaskini`,`notifikasi_email`,`t_lantikan`,`t_keluar`,`bml`,`bmp`,`bil`,`bip`,`lll`,`llp`,`llbahasa`,`gambar_base64`,`no_rujukan_jpa`,`no_rujukan_jabatan`,`alamat_emel_peribadi`,`nokp_waris`,`bilanak_waris`,`gaji_waris`,`oku_rujukan`,`id_negeri_pilihan1`,`id_negeri_pilihan2`,`id_skim`,`oku_catatan`,`id_oku`,`t_lantikan_pertama`,`t_sah_pertama`,`pasangan_hubungan`,`pasangan_nokp`,`pasangan_nama`,`pasangan_tel_rumah`,`pasangan_tel_bimbit`,`pasangan_pekerjaan`,`pasangan_jawatan`,`pasangan_majikan`,`pasangan_alamat_pejabat`,`pasangan_id_negeri`,`pasangan_id_daerah`,`pasangan_tel_pejabat`,`pasangan_emel`,`pasangan_gaji`,`pasangan_oku`,`pasangan_oku_rujukan`,`pasangan_oku_catatan`,`pasangan_id_oku`,`anak_oku`,`anak_oku_rujukan`,`anak_oku_catatan`,`anak_id_oku`,`anak_jumlah`,`urine_test`,`urine_tarikh`,`urine_catatan`,`psikometric_result`,`psikometric_catatan`,`tarikh_daftar`,`tarikh_kemaskini`,`ulasan_penjawatan`,`ulasan_pinjaman`,`no_kwsp`,`acc_bank`,`gaji_no`,`bank_no`,`bank_jenis_akaun`,`bank_nama`,`bank_alamat`,`bank_id_negeri`,`bank_id_daerah`,`pertukaran_indicator`,`t_sah_semasa`,`t_perkahwinan`,`t_pasangan_bertugas`,`t_bertugas`,`kelas_lesen_memandu`) values 
(88,'1234','Azman Zakaria',NULL,1,3,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'cRDtpNCeBiql5KOQsKVyrA0sAiA=',NULL,1,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,0,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
/*Data for the table `tb_penjawatan_pengguna` */
...
/*Data for the table `tb_penjawatan_skim_rekod 2017` */
...
/*Data for the table `tb_penjawatan_skim_rekod_archieve` */
...
/*Data for the table `tb_persaudaraan` */
...
/*Data for the table `tb_pertukaran_mohon` */
...
/*Data for the table `tb_pertukaran_ref_alasan` */
...
/*Data for the table `tb_pertukaran_ref_alasansub` */
...
/*Data for the table `tb_pertukaran_ref_route_status` */
...
/*Data for the table `tb_pertukaran_ref_status` */
...
/*Data for the table `tb_pertukaran_ref_statusmohon` */
...
/*Data for the table `tb_pertukaran_ref_ulasan` */
...
/*Data for the table `tb_pertukaran_route_status_sub` */
...
/*Data for the table `tb_rep_ringkasanpenjawatan` */
...
/*Data for the table `tb_takaktif` */
...
/*Data for the table `tb_tempat_bertugas_jenis` */
...
/*Data for the table `tb_warran_penjawatan` */
